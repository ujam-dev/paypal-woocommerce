...
class WC_Gateway_PayPal_Express_AngellEYE extends WC_Payment_Gateway {
    ...
    function paypal_express_checkout($posted = null) {
        ...
        elseif (isset($_GET['pp_action']) && $_GET['pp_action'] == 'revieworder') {
            ...
            if (($this->skip_final_review == 'yes' && get_option('woocommerce_enable_guest_checkout') === "yes") && (wc_get_page_id( 'terms' ) == -1 && apply_filters( 'woocommerce_checkout_show_terms', true ))) {
            ...
            if (isset($_POST) || (($this->skip_final_review == 'yes' && get_option('woocommerce_enable_guest_checkout') === "yes") || (wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true )))) {
